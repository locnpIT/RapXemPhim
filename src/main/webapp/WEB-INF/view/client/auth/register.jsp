    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Đăng kí - 22T3Cinema</title>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            <div class="card-header">
                                                <h3 class="text-center font-weight-light my-4">Tạo mới tài khoản</h3>
                                            </div>
                                            <div class="card-body">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                <form:input class="form-control" type="text"
                                                                    ...
                                                                    path="idTaiKhoan" />
                                                                <label for="inputLastName">Tài khoản</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-footer text-center py-3">
                                                <div class="small"><a href="/login">Bạn đã có tài khoản rồi? Đăng nhập thôiiii!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
