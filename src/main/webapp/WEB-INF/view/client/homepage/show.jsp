                        ...
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-1">
                                    <span class="text-dark" style="width: 130px;">Tất cả phim</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <c:forEach var="phim" items="${listPhim}">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            ...
                                            <div class="fruite-img">
                                                <img src="/images/phim/${phim.hinhAnh}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Phim hay</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4 style="font-size: 15px;">
                                                    
                                                    <a href="">${phim.tenPhim}</a>
                                                </h4>
                                                <p style="font-size: 13px;">${phim.daoDien}</p>
                                                <div class="d-flex  flex-lg-wrap justify-content-center">
                                                   
                                                   
                                                        
                                                        <a href="/phim/${phim.idPhim}" class="mx-auto border border-secondary rounded-pill px-3 text-primary">
                                                            <i class="fa fa-shopping-bag me-2 text-primary"></i> Đặt vé
                                                        </a>
